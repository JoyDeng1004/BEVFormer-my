...
def convert_annotation_list_to_dict(annotation_list, visibilities=['', '1', '2', '3', '4']):
  """
...
def main(version, dataroot, output, fps, output_size, minimum_frames, minimum_bb_area, visibility):
...
if __name__ == "__main__":
    ...
    main(args['version'], args['dataroot'], args['output'], 
